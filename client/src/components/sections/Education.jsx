...
const Education = () => {
  const education = [
    {
      ...
      duration: "2020 – 2024",
      description:
        "Built a strong foundation in full stack development, database systems, software engineering, and scalable web application development.",
    }
  ];
  ...
  return (
    <section
      id="education"
      className="py-32 px-6 overflow-hidden bg-white"
    >
            ...
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row gap-12 items-start md:items-center">
                ...
                <div className="flex-1 space-y-6">
                  ...
                  {/* College */}
                  <p className="text-xl font-bold text-blue-600/80 tracking-tight">
